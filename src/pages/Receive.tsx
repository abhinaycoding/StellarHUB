  ...
  return (
    ...
    >
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-white mb-2">Receive XLM</h1>
      ...
      <div className="bg-card border border-border rounded-xl p-8 text-center">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <button 
              onClick={handleCopy}
              className="flex-1 bg-surface hover:bg-white/10 text-white px-4 py-3 rounded-lg font-medium transition-colors border border-border flex items-center justify-center gap-2"
            >
              <Copy className="w-4 h-4" />
              Copy
            </button>
            <button className="flex-1 bg-white hover:bg-white/90 text-black px-4 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
