import { Bell, Search, Sun, Menu, Wallet } from "lucide-react";
  ...
  return (
    <header className="h-16 border-b border-border bg-background flex items-center justify-between px-6 sticky top-0 z-10">
      <div className="flex items-center gap-4">
        <button className="md:hidden p-2 text-text-secondary hover:text-white rounded-lg hover:bg-white/5 transition-colors">
        ...
        <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-surface rounded-lg border border-border focus-within:border-white/20 transition-colors">
          ...
          <input 
            ...
            className="bg-transparent border-none outline-none text-sm w-48 text-white placeholder:text-text-secondary"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="p-2 text-text-secondary hover:text-white rounded-lg hover:bg-white/5 transition-colors relative">
